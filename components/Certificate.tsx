...
const Certificate: React.FC = () => {
  ...
  const handleGenerate = () => {
    if (name.trim() && idNumber.trim()) {
      ...
      alert('Por favor, ingresa tu nombre completo y número de identificación.');
    }
  };
      ...
      <div>
        <div id="certificate-print-area" className="p-4 sm:p-8 bg-white border-8 border-blue-800 rounded-lg shadow-2xl relative w-full aspect-[1.414]">
            ...
            <div className="text-center relative">
              <p className="text-lg font-semibold text-gray-600">La Entidad Solidaria</p>
              <h1 className="text-4xl sm:text-5xl font-bold text-blue-800 mt-4">Certificado de Finalización</h1>
              <p className="mt-8 text-xl text-gray-700">otorga el presente certificado a:</p>
              ...
              <p className="mt-8 text-xl text-gray-700">
                por haber completado y aprobado satisfactoriamente el curso de
              </p>
              ...
              <div className="mt-12 flex justify-around items-end">
                <div>
                  <div className="border-t-2 border-gray-600 w-48 mx-auto pt-2">
